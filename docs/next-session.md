...
| **3 (H2)** | Per-project ~155-char `summary` for all 19 projects; wire `description: summary ?? description` | `src/data/projects.js`, `src/Components/ProjectDetail.jsx` | ⬜ queued (content authoring — not a "quick win") |
