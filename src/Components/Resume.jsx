...
const skills = {
  ...
  "AI Infrastructure & Developer Tools": [
    "Claude API",
    "Claude Code",
    "CAST v7.0 (23 agents, 12 Homebrew packages)",
    "Agent Architecture",
    "Tauri v2",
    "Ollama",
    "RAG / Embeddings",
