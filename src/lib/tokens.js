...
export const ACCENT_500 = "#7BA876";  // deepened sage  (6.7:1 on bg)
export const ACCENT_300 = "#A3C79E";  // lightened sage (9.8:1 on bg)
export const SLATE_700 = "#4A4030";   // brass/sepia hairline (border)
export const MUTED_FOREGROUND = "#B3A68C"; // secondary / caption ink
