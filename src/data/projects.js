...
const projects = [
  {
    ...
    description:
      "Persistent AI identity system — publicly archived. Extracts identity signals from conversations, compresses them with recency-weighted decay scoring, and injects a token-efficient payload at session start. Works across models and providers.",
  ...
  },
  {
    ...
    castEcosystem: true,
    stats: ["30 Agents", "81 Hooks", "44 Tests", "20 Commands", "12 Packages", "v6.0.1"],
  },
  {
  ...
  },
  {
    ...
    title: "cast-time",
    description:
      "A single-purpose Claude Code SessionStart hook that solves a fundamental LLM limitation: Claude has no clock. Injects local time, timezone, and a semantic time-of-day bucket (morning/afternoon/evening/night) at session start — no rules, no slash commands, just context. 2,000+ cloners in two weeks.",
    ...
    stats: ["Open Source", "SessionStart Hook", "2,000+ Cloners", "Homebrew Install"],
  },
  {
    slug: "cast-agents",
    title: "cast-agents",
